  ...
  + Trừu tượng (Abstraction): Trừu tượng có nghĩ là tổng quát hóa một cái gì đó lên. không cần chú ý chi tiết bên trong.
       ...
       */
        static void Main(string[] args)
        {
            ...
            string ten, diachi, quequan;
            int sdt;
            int input;
            bool flag;

            string tenCho, diachiCho, queQuanCho;
        
            //1. Khai báo 1 đối tượng
            //Biết tên đối tượng
            SinhVien sv1 = new SinhVien();//Tạo ra 1 đối tượng và chỉ lưu thông tin 1 đối tượng
            SinhVien sv2 = new SinhVien();

            SinhVien sv3;//Khai báo
            sv3 = new SinhVien();//Khởi tạo 1 đối tượng

            //2. Giá giá trị cho thuộc tính của đối tượng
            // <Tên biến đối tượng>.<thuộc tính> =  giá trị;
            sv1.ten = "Dũng";
            sv1.diachi = "Số 1 trịnh văn bô";
